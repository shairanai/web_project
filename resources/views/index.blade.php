        ...
        <div class="sidebar-logo">
          ...
          <div class="logo-header" data-background-color="dark">
            {{-- <a href="index.html" class="logo">
              <img
                src="{{asset('assetss/img/kaiadmin/logo_light.svg')}}"
                alt="navbar brand"
                class="navbar-brand"
                height="20"
              />
        ...
        <div class="main-header">
          ...
          >
            <div class="container-fluid">
              ...
              >
              <h3 class="fw-bold mb-3">SHASFYA'Sling Bag</h3>
                      ...
                      <div class="message-notif-scroll scrollbar-outer">
                        <div class="notif-center">
                          <a href="#">
                            <div class="notif-img">
                              <img
                                src="{{asset('assetss/img/jm_denis.jpg')}}"
                                alt="Img Profile"
                              />
                            </div>
          ...
          <div class="page-inner">
            ...
            >
              <div>
                ...
                <div class="row">
                  <div class="col-md-6">
                      <a href="/produk/create/" class="btn" style="background-color: #5e838f">Tambah Data</a><br>
                  </div>
                  <div class="col-md-6">
